...
## 数当てゲームを作ろう@showdialog
このチュートリアルでは、keypad を使って 数当てゲームを作るプログラムを作成します。
...
まず、keypad を micro:bit に接続しましょう。
